...
/**
 * Retorna o nome do OS utilizado
 * 
 * @return string  O nome do sistema operacional utilizado pelo usuário
 */
function getOS() { 
 ...
 * 
 * @return string Retorna o nome do navegador utilizado pelo usuário
 */
function getBrowser() {
    $user_agent     = $_SERVER['HTTP_USER_AGENT'];
